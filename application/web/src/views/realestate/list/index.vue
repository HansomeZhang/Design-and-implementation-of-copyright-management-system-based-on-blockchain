    ...
    <el-row v-loading="loading" :gutter="20">
      <el-col v-for="(val,index) in realEstateList" :key="index" :span="6" :offset="1">
        ...
        <el-card class="text item">
          ...
          <div class="item">
            <el-tag type="warning">文件类型: </el-tag>
            <span>{{ val.carmodel }}</span>
          </div>
          <div class="item">
            <el-tag type="danger">原作者: </el-tag>
            <span>{{ val.car_scz }}</span>
          </div>
          <div class="item">
            <el-tag type="warning">创作时间: </el-tag>
            <span>{{ val.car_scd }}</span>
          </div>
          <div class="item">
            <el-tag type="danger">作品简介: </el-tag>
            <span>{{ val.car_scsj }}</span>
          </div>
          <div class="item">
            <el-tag type="warning">作品分类: </el-tag>
            <span>{{ val.car_lbjph }}</span>
          </div>
          <div class="item">
            <el-tag type="danger">受众人群: </el-tag>
